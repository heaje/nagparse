<?php
	 ...
	 * @version 0.1
	 */
	class nagServicedependency extends nagObject implements nagObjectInterface{

		const NAG_OBJ_TYPE = 'servicedependency';
		...
		private static $relationships = array(
			'dependent_host_name' => true,
			'dependent_hostgroup_name' => true,
			'servicegroup_name' => true,
			'dependent_servicegroup_name' => true,
			'host_name' => true,
			'hostgroup_name' => true,
